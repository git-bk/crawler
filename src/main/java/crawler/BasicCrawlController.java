...
public class BasicCrawlController {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Do you need to set a proxy? If so, you can use: config.setProxyHost("proxyserver.example.com");
         * config.setProxyPort(8080); If your proxy also needs authentication: config.setProxyUsername(username);
